...
public class SCCMainPanel extends JPanel implements ActionListener {
	...
	public void applyEnterRoom(SCRoom room) {
		if(currentRoom.getRoomNum() == -1){
			connectionManager.send(new SCPacket("enterRoom",new Object[]{room}));
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Connect")){
			...
			connectionManager.send(new SCPacket("createRoom",new Object[]{roomField.getText()}));
		}
		else if(e.getActionCommand().equals("Send")){
			connectionManager.send(new SCPacket("writeMessage",new Object[]{msgField.getText()}));
			msgField.setText("");
		}
